...
import { getMerchantBannerAndFooter } from '@/services/merchant-parameters'
...
export default function Page(props: { params: Params }) {
  ...
  const bannerAndFooterQuery = useQuery({
    queryKey: ['bannerAndFooter', query.data?.product.merchant_id],
    queryFn: getMerchantBannerAndFooter,
  ...
  if (query.data?.product) {
    return (
      <div className="flex flex-col items-center justify-center w-full space-y-6">
        {bannerAndFooterQuery.data?.banner && (
          <Banner url={bannerAndFooterQuery.data.banner}></Banner>
        )}
        <div className="flex flex-col items-center lg:flex-row-reverse lg:items-start justify-center mt-10 lg:space-x-8 max-w-[70vw]">
          ...
          <div className=" flex flex-col justify-start lg:border-r-2 p-4 w-full">
            <h1 className="font-black">Dados cadastrais</h1>
            ...
            {paymentType === PaymentType.PIX && (
              <Card className="mt-4">
                <CardContent className="w-full mt-4 space-y-2">
                  ...
                  <p>
                    2 - Com o aplicativo do seu banco, escaneie o QR Code que
                    será gerado em sua compra
                  </p>{' '}
        ...
        {bannerAndFooterQuery.data?.footer && (
          <Footer url={bannerAndFooterQuery.data.footer}></Footer>
        )}

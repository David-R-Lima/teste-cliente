...
export function CreatePlanForm() {
    ...
    return (
        <Dialog>
            <DialogTrigger asChild><Button className="space-x-2"><Plus/><p>Plano</p></Button></DialogTrigger>
            <DialogContent className="flex flex-col min-w-[80vw] min-h-[90vh] overflow-auto">
                <DialogHeader>
                <DialogTitle>Cadastrar plano</DialogTitle>
                <DialogDescription>
                    <p>Utilize este formulário para cadastrar um novo plano de assinatura ao invés da api.</p>
                </DialogDescription>
                </DialogHeader>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex space-x-2">
                        <div className="flex items-center space-x-2">
                          <Checkbox checked={watch('is_test_period')} onClick={()=> {
                        ...
                        </div>
                        {
                            watch('is_test_period') && (
                              <Input type="number" min={1} {...register('test_days')} className="w-[100px]"></Input>
                            )
                        }
                      </div>
                    </div>

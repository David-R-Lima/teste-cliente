    ...
    <main>
      ...
      <div className="flex-col justify-center items-center min-h-[80vh] w-full">
        ...
        <div className="flex items-center justify-center p-10 w-full">
          <div className="flex justify-around p-6 space-x-4">
            ...
            <div className="border-2 p-4 w-[12rem] space-y-2 rounded-lg">
              ...
              <p className="italic">&quot;Melhor plataforma de pagamento do mercado&quot;</p>
            </div>
            <div className="border-2 p-4 w-[12rem] space-y-2 rounded-lg">
              <h1 className="text-primary">Maria</h1>
              <p className="italic">&quot;Fiquei surpreso com a simplicidade de tudo!&quot;</p>
            </div>
          </div>
        </div>
        ...
        <div className="flex items-center justify-center w-full mt-2">
          <h1 className="text-xl italic">Entre em contato conosco para saber mais!</h1>
        </div>
      ...
      <footer className="relative flex-col items-center justify-center p-8 h-[30vh] border-t-2 w-full">
        <div className="flex space-x-[8rem]">
            <div className="space-y-4 space-x-2">
              ...
              <div className="flex space-x-2 items-center">
                <CiMail size={25}/><p>atendimento@bttis.com</p>
              </div>
              <div className="flex space-x-2 items-center">
                <FaLocationDot size={25}/><p>Av Engenheiro Roberto Lassance, 1605, Loja, Vila Isa, Gov. Valadares/MG</p>
              </div>
              <div className="flex space-x-2 items-center">
                <FaRegClock size={25}/>
                <div>
          ...
          <div>
            <div className=" space-y-4 space-x-2">
              <h1 className="text-primary">Acesse</h1>
                <div>
                  <Link href={"/"} className="hover:text-primary hover:cursor-pointer hover:underline">Suporte</Link>
                </div>
                <div>
                  <Link href={"/"} className="hover:text-primary hover:cursor-pointer hover:underline">Documentação</Link>
                </div>
                <div>
                  <Link href={"/login"} className="hover:text-primary hover:cursor-pointer hover:underline">Acesse o dashboard</Link>
                </div>
            </div>
          </div>
        </div>
        <div className="flex items-center justify-center w-full">
          <p className="text-primary my-6">PagBttis é desenvolvido pela Bttis - Copyright 2024 - Todos os direitos reservados. CNPJ 33.657.781/0001-40</p>
        </div>
      </footer>
    </main>
  );

...
import { ProductComponent } from '@/app/checkout/[...id]/components/product'
import { ProductWithImageComponent } from '@/app/checkout/[...id]/components/product-with-image'
import { RenderQRCodeSectionPaymentLink } from '@/app/checkout/[...id]/components/render-qr-code'
...
export default function Page(props: { params: Params }) {
  ...
  const recommendedProductQuery = useQuery({
    queryKey: ['recommendedProduct', id, query.data?.product.merchantId],
    queryFn: async () => {
